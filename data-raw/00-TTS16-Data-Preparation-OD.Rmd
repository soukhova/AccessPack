...
In this notebook we process a cross-tabulation of origin and destinations by people employed full-time in the gha in 2016.
...
Plot worker population in the gha:
```{r}
ggplot() +
...
Plot job distribution in the gha:
```{r}
ggplot() +
  geom_sf(data = gha_taz,
          aes(fill = jobs),
...
Create centroids for each feature in gha_taz:
```{r}
